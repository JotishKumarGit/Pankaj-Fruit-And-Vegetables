    ...
    <div class="container-fluid bg-primary p-5 hero-header mb-5">
        <div class="row py-5">
            <div class="col-12 text-center">
                <h1 class="display-1 text-white animated zoomIn">Fresh Onion</h1>
                <a href="" class="h4 text-white">Home</a>
                <i class="far fa-circle text-white px-2"></i>
                <a href="" class="h4 text-white">Fresh Onion</a>
            </div>
        </div>
    </div>
    <!-- Hero End -->
        ...
        <div class="container">
            <div class="row align-items-center g-4">
                ...
                <div class="col-md-6">
                    ...
                    <p class="text-muted">
                        Our Fresh Onions are sourced from trusted farms to ensure superior quality, rich flavor,
                        and long shelf life. They are ideal for cooking, salads, and commercial food preparation.
                    </p>

                    <ul class="list-unstyled">
                        <li>✔ Grade A farm-fresh onions</li>
                        <li>✔ Rich aroma and strong flavor</li>
                        <li>✔ Cleaned and sorted for quality</li>
                        <li>✔ Available in bulk packing</li>
                    </ul>
